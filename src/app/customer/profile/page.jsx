...
const CustomerProfilePage = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        const res = await fetch("/api/customer/profile"); // <- endpoint changed
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-900 p-8 rounded-xl shadow-2xl max-w-xl">
        ...
        <div className="relative w-28 h-28 mx-auto mb-4">
          <img
            src={previewImage || "https://via.placeholder.com/150?text=User"}
            alt="Profile"
          ...
          {!isEditing ? (
            ...
            <button
              ...
              className={`w-full py-3 rounded-lg font-semibold flex justify-center gap-2 ${
                isSaving ? "bg-gray-700" : "bg-cyan-600 hover:bg-cyan-700"
              }`}
            >
